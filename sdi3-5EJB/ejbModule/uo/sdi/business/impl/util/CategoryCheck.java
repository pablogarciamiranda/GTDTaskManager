...
public class CategoryCheck {
	...
	public static void isValidUser(Category c) throws BusinessException {
		...
		BusinessCheck.isNotNull(u, MessageProvider.getValue("isValidUser"));
	...
	public static void isUniqueName(Category category) throws BusinessException {
		...
		BusinessCheck.isNull(other, MessageProvider.getValue("isUniqueName"));
	}
	...
	public static void isNotForAdminUser(Category category)
		...
		BusinessCheck.isFalse(u.getIsAdmin(),
				MessageProvider.getValue("isNotForAdminUser"));
	}
